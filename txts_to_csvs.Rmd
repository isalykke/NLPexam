...
test <- read_and_preprocess(txts[199])
...
The following block takes the preprocessed data in csv form and transforms it to a dataset that has one full episode pr row instead of one speaker utterance per row. This is saved as a new csv

This is quite possibly the most computationally heavy way to arrive at the result, but hey, if it works it works.
